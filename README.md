...
```
cd existing_repo
git remote add origin https://gitlab.com/wallet-wise/api-gateway.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/wallet-wise/api-gateway/-/settings/integrations)
